...
<html>
    ...
    <body>       
        <nav>
            ...
            <div id="links">
                ...
                <a href="<?php echo e(url('cerca')); ?>">Cerca</a>
    ...
    <div id="contenitoreImpostazioni">
                ...
                <?php if($error == "Inserisci la nuova password"): ?>
                <div class="errore">Inserisci la nuova password</div>
                <?php elseif($error == "Inserisci la vecchia password"): ?>
                <div class="errore">Inserisci la vecchia password</div>
                <?php elseif($error == "Inserisci la conferma password"): ?>
                <div class="errore">Inserisci la conferma password</div>
                <?php elseif($error == "Le due password non corrispondono"): ?>
                <div class="errore">Le due password non corrispondono</div>
                <?php elseif($error == "La vecchia password è sbagliata"): ?>
                <div class="errore">La vecchia password è sbagliata</div>   
                <?php endif; ?>

                <?php if(Session::get('Messaggio') == "Password Cambiata"): ?>
                <div class='messaggio'>Password modificata</div>
                <?php endif; ?>

                <?php if(Session::get('Messaggio') == "Immagine Cambiata"): ?>
                <div class='messaggio'>Immagine modificata</div>
                <?php endif; ?>

                <?php if(Session::get('Messaggio') == "Copertina Cambiata"): ?>
...
</html><?php /**PATH C:\Users\Pierg\OneDrive\Desktop\xamp\htdocs\app\resources\views/profilo.blade.php ENDPATH**/ ?>